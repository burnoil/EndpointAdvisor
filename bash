...
function Install-ADTDeployment
{
    ...
    ## Welcome / close apps
	Show-ADTInstallationPrompt -Message 'This will upgrade your Office installation to Microsoft 365 Apps for Enterprise. Any open Office apps will be forcibly closed if still open. All other apps willbe minimized. Please save your work before continuing.' -ButtonMiddleText 'Ok'
